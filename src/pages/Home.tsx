        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-700">
              Join us at the AI Innovation Summit 2025, where industry leaders
              and experts will explore the latest trends and advancements in
              artificial intelligence. Discover how AI is shaping the future of
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white bg-opacity-10 p-8 rounded-xl backdrop-blur-lg">
              ...
              <p>
                Enhance productivity and streamline operations with our
                AI-powered virtual assistant. Designed to respond to user
            ...
            <div className="bg-white bg-opacity-10 p-8 rounded-xl backdrop-blur-lg">
              ...
              <p>
                Accelerate innovation with our affordable AI-based prototyping
                solutions. From concept to reality, our tools enable rapid
                development.
              </p>
            </div>
            <div className="bg-white bg-opacity-10 p-8 rounded-xl backdrop-blur-lg">
              ...
              <p>
                ...
                Gain actionable insights into customer behavior and business
                performance.
              </p>
            </div>
          </div>
